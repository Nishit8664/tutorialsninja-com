Feature: My Account Test
  ...
  Scenario: User should register account successfully
    When I click on my account link
    And I call the method selectMyAccountOptions method and pass the parameter "Register"
    And I enter First Name "Nishit"
    And I enter Last Name "Chitaliya"
    And I enter Email "nishit"
    And I enter Telephone "07605412474"
    And I enter Password "Nishit8664"
    And I enter Confirm Password "Nishit8664"
  ...
  Scenario: User should login and logout successfully
    When I click on my account link
    And I call the method selectMyAccountOptions method and pass the parameter "Login"
    And I enter Email "nishitchitaliya@gmail.com" on login page
    And I enter password "Nishit8664" on login page
